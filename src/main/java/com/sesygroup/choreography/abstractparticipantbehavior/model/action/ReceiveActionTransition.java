...
public class ReceiveActionTransition extends Transition implements Serializable {
   ...
   public ReceiveActionTransition(final State sourceState, final State targetState, final InputMessage inputMessage) {
   ...
   public String toString() {
      return "(" + sourceState + ", " + inputMessage + ", " + targetState + ")";
   }
}
